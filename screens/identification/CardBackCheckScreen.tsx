...
const CardBackCheckScreen = ({ navigation }: { navigation: any }) => {
    return (
        <SafeAreaView style={styles.container} edges={['top']}>
            ...
            <View style={styles.bodyContainer}>
                ...
                <View style={styles.scanContainer}>
                    <Image source={require('@/assets/images/specimen-id-card-back.png')} resizeMode='contain' style={styles.capturedImage} />
                </View>
                <View style={{ paddingBottom: 20, paddingHorizontal: 22, gap: 10 }}>
                    <PrimaryButton title='Vazhdo' backgroundColor={Colors.primaryColor} onButtonPressed={() => navigation.navigate('FaceInfoScreen')} />
...
export default CardBackCheckScreen
